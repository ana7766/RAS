...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    <head>
        ...
        <title>Upravljaj kategorijom</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="reg-users.php">Registrovani Korisnici</a></li>
                                    <li class="active">Registrovani korisnici</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Registrovani korisnici</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="reg-users.php?del=<?php echo $row['ID']; ?>" class="btn btn-danger"
