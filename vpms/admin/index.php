...
if (isset($_POST['login'])) {
    ...
    if ($ret > 0) {
        ...
        echo "<script>alert('Detalji nisu ispravni.');</script>";
    }
}
?>
<!doctype html>
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">Parking sistem</h2>
                    </a>
                </div>
                <div class="login-form">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Korisnicko ime" required="true"
                                name="username">
                        </div>
                        <div class="form-group">
                            <label>Lozinka</label>
                        ...
                        <button type="submit" name="login" class="btn btn-success btn-flat m-b-30 m-t-30">
                        Uloguj se</button>
