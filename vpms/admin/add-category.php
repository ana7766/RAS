...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            echo "<script>alert('Kategorija uspijesno dodata');</script>";
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="add-category.php">Kategorija</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Dodaj </strong> Kategoriju
                            </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input"
                                                class=" form-control-label">Naziv Kategorije</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="catename" name="catename"
                                                class="form-control" placeholder="Kategorija Vozilo" required="true"></div>
                                    </div>
