...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query) {
            ...
            echo "<script>alert('Detalji uspijesno azurirani');</script>";
        } else {
    ...
    <head>
        ...
        <title>Upravljanje kategorijom</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-category.php">Kategorija</a></li>
                                    <li class="active">Azuriraj kategoriju</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Azuriraj </strong> Kategoriju
                            </div>
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) {
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input"
                                                    class=" form-control-label">Kategorija</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="catename" name="catename"
                                                    class="form-control" placeholder="Kategorija vozila" required="true"
                                                    value="<?php echo $row['VehicleCat']; ?>"></div>
                                        </div>
