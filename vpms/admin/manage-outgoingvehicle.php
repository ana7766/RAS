                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-outgoingvehicle.php">Upravljaj Vozilima</a></li>
                                    <li class="active">Upravljaj Izlazima Vozila</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Upravljaj Izlazima Vozila</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="view-outgoingvehicle-detail.php?viewid=<?php echo $row['ID']; ?>"
                                                ...
                                                <a href="manage-outgoingvehicle.php?del=<?php echo $row['ID']; ?>"
