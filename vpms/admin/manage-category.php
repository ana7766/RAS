                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Upravljaj Kategorijom</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Upravljaj Kategorijom</strong>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit-category.php?editid=<?php echo $row['ID']; ?>"
                                                    class="btn btn-primary">Uredi</a>
                                                <a href="manage-category.php?del=<?php echo $row['ID']; ?>"
