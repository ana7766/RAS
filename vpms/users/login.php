...
if (isset($_POST['login'])) {
    ...
    if ($ret > 0) {
        ...
        echo "<script>alert('Neispravni detalji.');</script>";
    }
}
?>
<!doctype html>
                ...
                <div class="login-form">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label>Registrovani Email ili kontakt broj</label>
                            <input type="text" name="emailcont" required="true" placeholder="Email ili broj telefona"
                                required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" placeholder="Unesi lozinku" required="true"
                                class="form-control">
                        </div>
                        <div class="checkbox">
                        ...
                        <button type="submit" name="login" class="btn btn-success btn-flat m-b-30 m-t-30">PRIJAVI
                            SE</button>
